import { Chart, CategoryScale, LinearScale, PointElement, RadialLinearScale, ArcElement, Title, Filler, Legend, Tooltip } from "chart.js";
...
Chart.register(CategoryScale, LinearScale, PointElement, RadialLinearScale, ArcElement, Title, Filler, Legend, Tooltip)

export default function PolarAreaChart({ datasets, labels, variables, id, change, dataDropdown }) {
    const structure = {
        label: "",
        data: [],
        tension: 0.3,
