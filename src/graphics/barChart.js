import { Chart, CategoryScale, LinearScale, PointElement, BarElement, Title, Filler, Legend, Tooltip } from "chart.js";
...
Chart.register(CategoryScale, LinearScale, PointElement, BarElement, Title, Filler, Legend, Tooltip)

export default function BarChart({ datasets, labels, variables, id, change, dataDropdown }) {
    const structure = {
        label: "",
        data: [],
        tension: 0.3,
