import { Chart, CategoryScale, LinearScale, PointElement, LineElement, Title, Filler, Legend, Tooltip } from "chart.js";
...
Chart.register(CategoryScale, LinearScale, PointElement, LineElement, Title, Filler, Legend, Tooltip)

export default function LineChart({ datasets, labels, variables, id, change, dataDropdown }) {
    const structure = {
        label: "",
        data: [],
        tension: 0.3,
